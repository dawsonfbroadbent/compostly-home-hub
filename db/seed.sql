...
INSERT INTO user_account (first_name, last_name, email, password, pickup_or_dropoff, street_address, city, state, zip_code, region_id) VALUES
('Logan', 'Smith', 'logan@example.com', 'pbkdf2_sha256$hashed_placeholder', 'pickup', '123 Main St', 'Salt Lake City', 'UT', '84101', 101),
('Ethan', 'Doe', 'ethan@example.com', 'pbkdf2_sha256$hashed_placeholder', 'dropoff', '456 Green Ave', 'Provo', 'UT', '84601', 102),
('Broc', 'Jefferson', 'broc@example.com', 'pbkdf2_sha256$hashed_placeholder', 'pickup', '22 Dirt Ave', 'Ogden', 'UT', '84401', 103),
('Garrett', 'Johnson', 'garrett@example.com', 'pbkdf2_sha256$hashed_placeholder', 'dropoff', '789 Earth Rd', 'Logan', 'UT', '84321', 104);
